...
GRANT CREATE VIEW TO RV_RENTAL_APP;
GRANT CREATE TABLE TO RV_RENTAL_APP;
GRANT CREATE PROCEDURE TO RV_RENTAL_APP;
GRANT CREATE SEQUENCE TO RV_RENTAL_APP;
ALTER USER RV_RENTAL_APP
